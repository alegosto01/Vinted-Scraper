...
def check_item(true_option, wrong_option, image):
    ...
    inputs = processor(text=[true_option, wrong_option, "something else"], images=image, return_tensors="pt", padding=True)
...
for image in os.listdir("/home/ale/Desktop/Vinted-Web-Scraper/air force 1 bianche/air force 1 bianche images"):
    ...
    prob = check_item("air force 1 full white shoes", "air force with light blue swoosh shoes",file_path)
    # if prob < 0.95:
    #     os.remove(file_path)
