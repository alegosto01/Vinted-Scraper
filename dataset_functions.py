...
def check_if_item_got_sold(csv_path, chunk_size):
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        for i, (_, row) in enumerate(df_to_check_iter.iterrows()):
            if i >= chunk_size:  # Stop after X iterations
                break
            futures.append(executor.submit(scraper.fetch_page_and_check, row))
...
check_if_item_got_sold("/home/ale/Desktop/Vinted-Web-Scraper/big_csv/big_csv.csv", 100)